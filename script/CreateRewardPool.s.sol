...
contract CreateRewardPool is Script {
    ...
    function run() external {
        ...
        //     unlocked: true,
        //     rewardToken: 0xc98D64DA73a6616c42117b582e832812e7B8D57F, // Rss3
        //     whitelistRoot: 0x
        // });
        rewardPool = IReward.RewardPool({
            unlocked: true,
            rewardToken: 0x582d872A1B094FC48F5DE31D3B73F2D9bE47def1, //TON
            whitelistRoot: 0x00
        });
        // vm.startBroadcast(deployerPrivateKey);
        // reward.createRewardPool(rewardPool);
        // vm.stopBroadcast();
    }
}
